...
# Helper functions
def generate_insights(stats, correlation):
    """Generate insights using OpenAI API based on stats and correlation."""
    prompt = {
        "numeric_summary": stats.select_dtypes(include='number').describe().to_dict(),
        "categorical_summary": stats.select_dtypes(include='object').describe().to_dict(),
        "correlation_summary": correlation.to_dict(),
        "questions": [
            "What are the key insights from this data?",
            "Are there any patterns or anomalies to note?",
            "What recommendations can be provided based on these insights?"
        ]
    }
    try:
...
def process_data(file_path):
    ...
    try:
        ...
        stats = data_imputed.describe(include='all')
        ...
        # Generate insights
        insights = generate_insights(stats, correlation)
        ...
        print("Results saved to 'stats.csv' and 'insights.txt'.")
